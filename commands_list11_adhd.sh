...
for e in "${E_VALUES[@]}"; do
    for p in "${P_VALUES[@]}"; do
        for m in "${MODEL_VALUES[@]}"; do
            ./multimodal_kfold_train_cvae_supervised.py -P $p -E $e -Model $m -K 10 -R ADHD
            ./multimodal_kfold_test_cvae_supervised.py -P $p -K 10 -R ADHD
            ./multimodal_kfold_cvae_group_analysis_1x1.py -P $p -E $e -Model $m -K 10 -R ADHD
        done
    done
done
