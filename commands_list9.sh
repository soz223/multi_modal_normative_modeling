    ...
    for p in "${P_VALUES[@]}"; do
        for m in "${MODEL_VALUES[@]}"; do
            for k in "${K_VALUES[@]}"; do
                ./multimodal_kfold_train_cvae_supervised.py -P $p -E $e -Model $m -K $k -TrainingClass 'dm'
                ./multimodal_kfold_test_cvae_supervised.py -P $p -K $k
                ./multimodal_kfold_cvae_group_analysis_1x1.py -P $p -E $e -Model $m -K $k -TrainingClass 'dm'
            done
        done
    done
done
