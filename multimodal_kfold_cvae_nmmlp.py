...
from utils import COLUMNS_HCP, COLUMNS_NAME, load_dataset, COLUMNS_NAME_SNP, COLUMNS_NAME_VBM, COLUMNS_3MODALITIES, COLUMNS_NAME_AAL116, get_column_name, get_datasets_name, get_hc_label, generate_kfold_ids_endtoend, generate_kfold_ids_with_unigroup, generate_kfold_ids
...
if __name__ == "__main__":
    ...
    parser.add_argument('action', choices=['train', 'test', 'analyze', 'all'], help='Action to perform, train, test, analyze, or all.')
